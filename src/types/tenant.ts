...
export const RESOURCE_CATEGORIES: ResourceCategory[] = [
  ...
  },
  {
    ...
    subcategories: [
      { id: 'transport-rules', name: 'Transport Rules', powershellModule: 'ExchangeOnlineManagement', supported: true },
      { id: 'connectors', name: 'Connectors', powershellModule: 'ExchangeOnlineManagement', supported: true },
      { id: 'accepted-domains', name: 'Accepted Domains', graphEndpoint: '/domains', supported: true },
      { id: 'mailbox-policies', name: 'Mailbox Policies', powershellModule: 'ExchangeOnlineManagement', supported: true },
      ...
      { id: 'org-config', name: 'Organization Config', powershellModule: 'ExchangeOnlineManagement', supported: true },
      { id: 'owa-policies', name: 'OWA Mailbox Policies', powershellModule: 'ExchangeOnlineManagement', supported: true },
      { id: 'mobile-device-policies', name: 'Mobile Device Policies', powershellModule: 'ExchangeOnlineManagement', supported: true },
    ],
    exportFormats: [
      { id: 'json', name: 'JSON', extension: '.json', supported: true },
      { id: 'powershell', name: 'PowerShell', extension: '.ps1', supported: true },
