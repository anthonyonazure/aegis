...
export const RESOURCE_CATEGORIES: ResourceCategory[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'guest-policies', name: 'Guest Access Policies', powershellModule: 'MicrosoftTeams', supported: true },
      { id: 'external-access', name: 'External Access Settings', powershellModule: 'MicrosoftTeams', supported: true },
