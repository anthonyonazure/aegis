...
export const RESOURCE_CATEGORIES: ResourceCategory[] = [
  ...
  },
  {
    ...
    icon: 'Mail',
    description: 'Mail flow rules, connectors, EOP & Defender policies',
    subcategories: [
      { id: 'transport-rules', name: 'Transport Rules', exoEndpoint: 'Get-TransportRule', supported: true },
      { id: 'connectors', name: 'Connectors (Inbound & Outbound)', exoEndpoint: 'Get-InboundConnector', supported: true },
      { id: 'accepted-domains', name: 'Accepted Domains', exoEndpoint: 'Get-AcceptedDomain', supported: true },
      { id: 'mailbox-policies', name: 'Mailbox Policies', exoEndpoint: 'Get-MailboxPolicy', supported: true },
      { id: 'anti-spam', name: 'Anti-Spam Policies', exoEndpoint: 'Get-HostedContentFilterPolicy', supported: true },
      { id: 'anti-phishing', name: 'Anti-Phishing Policies', exoEndpoint: 'Get-AntiPhishPolicy', supported: true },
      { id: 'anti-malware', name: 'Anti-Malware Policies', exoEndpoint: 'Get-MalwareFilterPolicy', supported: true },
      { id: 'safe-links', name: 'Safe Links Policies', exoEndpoint: 'Get-SafeLinksPolicy', supported: true },
      { id: 'safe-attachments', name: 'Safe Attachments Policies', exoEndpoint: 'Get-SafeAttachmentPolicy', supported: true },
      { id: 'dlp-policies', name: 'DLP Policies', exoEndpoint: 'Get-DlpCompliancePolicy', supported: true },
      { id: 'org-config', name: 'Organization Config', exoEndpoint: 'Get-OrganizationConfig', supported: true },
      { id: 'owa-policies', name: 'OWA Mailbox Policies', exoEndpoint: 'Get-OwaMailboxPolicy', supported: true },
      { id: 'mobile-device-policies', name: 'Mobile Device Policies', exoEndpoint: 'Get-MobileDeviceMailboxPolicy', supported: true },
      { id: 'retention-policies', name: 'Retention Policies', exoEndpoint: 'Get-RetentionPolicy', supported: true },
    ],
    exportFormats: [
      { id: 'json', name: 'JSON', extension: '.json', supported: true },
      { id: 'powershell', name: 'PowerShell', extension: '.ps1', supported: true },
  ...
  },
  {
    ...
    subcategories: [
      { id: 'tenant-settings', name: 'Tenant Settings', powershellModule: 'PnP.PowerShell', supported: true },
      { id: 'sharing-policies', name: 'Sharing Policies', powershellModule: 'PnP.PowerShell', supported: true },
      ...
      { id: 'access-control', name: 'Access Control Settings', powershellModule: 'PnP.PowerShell', supported: true },
      { id: 'storage-quota', name: 'Storage Quota Settings', powershellModule: 'PnP.PowerShell', supported: true },
      { id: 'onedrive-settings', name: 'OneDrive Settings', powershellModule: 'PnP.PowerShell', supported: true },
    ],
    exportFormats: [
      { id: 'json', name: 'JSON', extension: '.json', supported: true },
      { id: 'powershell', name: 'PowerShell', extension: '.ps1', supported: true },
  ...
  },
  {
    ...
    subcategories: [
      { id: 'messaging-policies', name: 'Messaging Policies', powershellModule: 'MicrosoftTeams', supported: true },
      { id: 'meeting-policies', name: 'Meeting Policies', powershellModule: 'MicrosoftTeams', supported: true },
      { id: 'app-policies', name: 'App Permission Policies', graphEndpoint: '/appCatalogs/teamsApps', supported: true },
      { id: 'calling-policies', name: 'Calling Policies', powershellModule: 'MicrosoftTeams', supported: true },
      { id: 'live-event-policies', name: 'Live Event Policies', powershellModule: 'MicrosoftTeams', supported: true },
      { id: 'guest-policies', name: 'Guest Access Settings', graphEndpoint: '/teamwork/teamSettings', supported: true },
      { id: 'external-access', name: 'External Access Settings', graphEndpoint: '/teamwork/teamSettings', supported: true },
      { id: 'app-setup-policies', name: 'App Setup Policies', powershellModule: 'MicrosoftTeams', supported: true },
      { id: 'channel-policies', name: 'Channel Policies', powershellModule: 'MicrosoftTeams', supported: true },
    ],
    exportFormats: [
      { id: 'json', name: 'JSON', extension: '.json', supported: true },
      { id: 'powershell', name: 'PowerShell', extension: '.ps1', supported: true },
