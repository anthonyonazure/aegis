...
export const RESOURCE_CATEGORIES: ResourceCategory[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'anti-spam', name: 'Anti-Spam Policies', powershellModule: 'ExchangeOnlineManagement', supported: true },
      { id: 'anti-phishing', name: 'Anti-Phishing Policies', powershellModule: 'ExchangeOnlineManagement', supported: true },
